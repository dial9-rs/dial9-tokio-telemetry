...
mod skills {
    pub const HEADER: &str = include_str!("../skills/header.md");
    pub const LOADING: &str = include_str!("../skills/loading.md");
    pub const ANALYSIS: &str = include_str!("../skills/analysis.md");
    pub const RECIPES: &str = include_str!("../skills/recipes.md");
    pub const RED_FLAGS: &str = include_str!("../skills/red-flags.md");

    // Generated by build.rs from toolkit/ directory
        ...
        Commands::Agents { action } => match action {
            ...
            Some(AgentsAction::Skill { name }) => match skills::get(&name) {
                ...
                None => {
                    ...
                    for (name, desc) in skills::SEGMENTS {
